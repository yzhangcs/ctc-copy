...
import argparse
from ctc.parser import CTCParser


def convert(file, fout, fin, fpath, max_len=64):
    count, sentence = 0, []
    tokenize_func = CTCParser.load(fpath).SRC.tokenize
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Output files in line with m2scorer eval format.')
